...
export default function CasePR() {
  ...
  useEffect(() => {
    const fetchData = async () => {
      ...
      myData = myData.filter((x) => x.category && x.category.includes('PR'));
      setData(myData);
    };
    fetchData();
  }, []);
  ...
  const handleSubmit = (event) => {
    ...
    postData?.note.push(postData.note1);
    ...
    <Page title="User | AIVC">
      <Container>
                          ...
                          >
                            <TableCell padding="checkbox">
                              <Checkbox
                                ...
                                onChange={(event) => handleClick(event, clientName)}
                              />
                            </TableCell>
                            ...
                            <TableCell align="right">
                              <UserMoreMenu rowId={id} rowData={row} />
                            </TableCell>
                          </TableRow>
                        );
                      })}
        ...
        <Dialog open={openDialog} onClose={handleClose}>
          <DialogTitle>Create New PR File</DialogTitle>
          <DialogContent>
            {/* <DialogContentText>
